...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "teacher.textUpload": "Text",
    "teacher.fileUpload": "File",
    "teacher.clickToUpload": "Click to upload a file",
    "teacher.supportedFormats": "TXT, PDF, DOCX, MD, CSV, JSON, XML, HTML",
    "teacher.maxFileSize": "Max 50 MB",
    "teacher.uploadingIndexing": "Uploading & Indexing...",
    "teacher.createAssignment": "Create Assignment",
    "teacher.assignmentTitle": "Title",
    "teacher.assignmentDescription": "Description",
    "teacher.titlePlaceholder": "e.g. Algebra Problem Set #1",
    "teacher.descPlaceholder": "Describe the assignment...",
    "nav.createAssignment": "+ Assignment",
    "download": "Download",
  ...
  ru: {
    ...
    "teacher.textUpload": "Текст",
    "teacher.fileUpload": "Файл",
    "teacher.clickToUpload": "Нажмите, чтобы загрузить файл",
    "teacher.supportedFormats": "TXT, PDF, DOCX, MD, CSV, JSON, XML, HTML",
    "teacher.maxFileSize": "Макс. 50 МБ",
    "teacher.uploadingIndexing": "Загрузка и индексация...",
    "teacher.createAssignment": "Создать задание",
    "teacher.assignmentTitle": "Название",
    "teacher.assignmentDescription": "Описание",
    "teacher.titlePlaceholder": "например, Алгебра Задание #1",
    "teacher.descPlaceholder": "Опишите задание...",
    "nav.createAssignment": "+ Задание",
    "download": "Скачать",
